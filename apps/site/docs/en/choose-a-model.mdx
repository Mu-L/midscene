...
MIDSCENE_MODEL_NAME="ui-tars:latest"
```

If you are using Ollama and Midscene Chrome extension, make sure to config the `OLLAMA_ORIGINS` params while launching `ollama serve` to prevent 403 error.
